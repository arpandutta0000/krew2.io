!function (t, i) {
    "object" == typeof exports && "object" == typeof module ? module.exports = i() : "function" == typeof define && define.amd ? define("GrowlNotification", [], i) : "object" == typeof exports ? exports.GrowlNotification = i() : t.GrowlNotification = i()
}(window, function () {
    return function (t) {
        var i = {};
        ...
        return o.m = t, o.c = i, o.d = function (t, i, n) {
            ...
            if (o.r(n), Object.defineProperty(n, "default", {
                enumerable: !0,
                value: t
            }), 2 & i && "string" != typeof t) for (var e in t) o.d(n, e, function (i) {
                return t[i]
            }.bind(null, e));
            return n
        }, o.n = function (t) {
        ...
        "use strict";
        Object.defineProperty(i, "__esModule", {value: !0}), Number.isInteger = Number.isInteger || function (t) {
            return "number" == typeof t && isFinite(t) && Math.floor(t) === t
        };
        var n = function () {
            function t(i, o) {
                if (this.nodes = [], this.pseudoSelector = "", this.callbacks = {}, o || (o = document), "string" == typeof i) if ("<" === i[0] && ">" === i[i.length - 1]) this.nodes = [t.createNode(i)]; else {
        ...
        var n = o(0), e = function () {
            ...
            return t.prototype.calculate = function () {
                ...
                var i = [];
                return n.default.select(".growl-notification.position-" + t.position).each(function (t) {
                    i.push(n.default.select(t))
                }), i
            }, t.position = "top-right", t
        }();
        ...
        var n = o(0), e = function () {
            ...
            return t.prototype.calculate = function () {
                var i = this, o = this.margin + 45;
                n.default.select(".growl-notification-center.position-" + t.position).each(function (t) {
                    var e = n.default.select(t);
                    e.css("top", o).css("left", "calc(50% - " + Math.ceil(e.width() / 2) + "px)"), o += e.height() + i.margin
                })
            }, t.prototype.instances = function () {
                var i = [];
                return n.default.select(".growl-notification-center.position-" + t.position).each(function (t) {
                    i.push(n.default.select(t))
                }), i
            }, t.position = "top-center", t
        }();
        ...
        var n = o(0), e = function () {
            ...
            }, t.position = "bottom-left", t
        }();
        i.BottomLeftPosition = e
    }, function (t, i, o) {
        "use strict";
        o(10), o(15), o(17);
        var n = o(8), e = o(9), s = o(0), r = o(2), c = o(1), a = o(4), u = o(5), l = o(6), f = o(3), p = function () {
            function t(i) {
                void 0 === i && (i = {}), this.options = e.all([t.defaultOptions, t.globalOptions, i]), this.options.animationClose && "none" != this.options.animationClose || (this.options.animationDuration = 0), this.notification = s.default.create("div"), this.body = s.default.select("body"), this.template = t.template, this.position = n.PositionFactory.newInstance(this.options.position, this.notification, this.options.margin), t.instances.push(this)
            }
            ...
            return Object.defineProperty(t, "defaultOptions", {
                ...
                void 0 === i && (i = 0);
                var o = !1, n = s.default.select(window).height();
                ...
                t.instances = [], s.default.select(t.position === "top-center" ? ".growl-notification-center" : ".growl-notification").each(function (t) {
                ...
                var t = this;
                this.notification.removeClass("animation-" + this.options.animationOpen).addClass("animation-" + this.options.animationClose).addClass("growl-notification--closed"), setTimeout(function () {
                ...
                this.options.showButtons && (this.notification.find(".growl-notification__button--action").on("click", function (i) {
        ...
        "use strict";
        Object.defineProperty(i, "__esModule", {value: !0});
        var n = o(1), e = o(2), s = o(3), r = o(4), c = o(5), a = o(6), u = function () {
            function t() {
            }
        ...
        t.exports = function () {
            ...
            function e(i, s, r) {
                ...
                var c = Array.isArray(s), a = Array.isArray(i), u = c === a;
