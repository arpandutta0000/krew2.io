module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            servercore: {
                src: [
                    'src/server/core/core_pre_concat.js',
                    'src/server/core/core.js',
                    'src/server/core/core_utils.js',
                    'src/server/core/core_goods_types.js',
                    'src/server/core/core_entity.js',
                    'src/server/core/core_player.js',
                    'src/server/core/core_item_types.js',
                    'src/server/core/core_item.js',
                    'src/server/core/core_boat_types.js',
                    'src/server/core/core_boat.js',
                    'src/server/core/core_impact.js',
                    'src/server/core/core_pickup.js',
                    'src/server/core/core_landmark.js',
                    'src/server/core/core_mongo_functions.js',
                    'src/server/core/core_projectile.js',
                    'src/server/core/core_config.js',
                    'src/server/core/core_server_entity.js',
                    'src/server/core/core_post_concat.js',
                ],
